...
ri = RuleIndex()
target_t = Template(target, [zero, succ, invented, target], ri, max_var=3, not_identical=invented)
invented_t = Template(invented, [zero, succ, invented, target], ri, max_var=3, not_identical=target)
