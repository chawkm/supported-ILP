...
with tf.Graph().as_default():
    ...
    # weight_initial_value = tf.ones([len(grounder.grounded_rules)]) * -1.0
    ...
    # ranked_model1 = tf.Variable(tf.random_uniform([len(ground_indexes)], maxval=1, dtype=tf.float32), dtype=tf.float32)
    ...
    # ranked_loss = RANK_WEIGHT * ex.pairwise_losses(ranked_model1, weight_stopped, data_weights, data_bodies, data_negs)
    ...
    # ranked_loss2 = RANK_WEIGHT * ex2.pairwise_losses(ranked_model2, weight_stopped, data_weights2, data_bodies2, data_negs2)
    ...
    # ranked_loss3 = RANK_WEIGHT * ex3.pairwise_losses(ranked_model3, weight_stopped, data_weights3, data_bodies3,
    #                                                 data_negs3)


    # loss2 = support_loss2 + lasso_loss2 + lasso_model2 + lasso_model2 + lasso_model3
    ...
    with tf.Session() as sess:
        ...
        for i in range(EPOCHS):
            ...
            # print("ranked loss", sess.run([ranked_loss, ranked_loss2, ranked_loss3]))
